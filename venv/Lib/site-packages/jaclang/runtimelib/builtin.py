...
# `override` was added to typing in newer Python versions. Provide a
# compatibility fallback that tries `typing_extensions.override` and
# otherwise defines a no-op decorator so the package still works on
# older Python stdlib typing modules.
try:
    # Python 3.12+ exposes `override` in typing
    from typing import override  # type: ignore
except Exception:
    try:
        from typing_extensions import override  # type: ignore
    except Exception:
        # Define a no-op override decorator
